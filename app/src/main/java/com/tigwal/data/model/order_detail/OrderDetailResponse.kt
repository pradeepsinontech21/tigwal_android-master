...
import com.tigwal.data.model.product_listing.ImagesItem
...
data class ordercalculationItem(
    @field:SerializedName("admin_commission")
    val admin_commission: Double? = 0.0,
...
data class Data(
    ...
    @field:SerializedName("ordercalculation")
    val ordercalculation: List<ordercalculationItem?>? = null,
