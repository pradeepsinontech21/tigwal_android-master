...
class SubCategoryAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val deals = LayoutInflater.from(parent.context)
            .inflate(R.layout.row_sub_category_list, parent, false)
        ...
        if (arrayListCategory[position].categoryImage != null && !arrayListCategory[position].categoryImage.equals(
            ...
            holder.itemView.setOnClickListener {
                onItemClickLister!!.itemClicked(
                    holder.itemView,
                    position,
                    arrayListCategory[position]
                )
            }

            arrayListCategory[position]!!.categoryImage?.let { Log.e("Image :", it) };
        }else{
            holder.imgCategory.setImageResource(R.drawable.img_placeholder)
        }
    }
}